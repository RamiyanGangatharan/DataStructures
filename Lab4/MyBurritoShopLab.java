...
public class MyBurritoShopLab {
        ...
        while (option != -1) {
            ...
            switch (option) {
                ...
                case 3: // Ring out burrito order
                    ...
                    shop.getNextTransaction();

                    break;
                case 4: // Wash a single dish

                    //TO-DO: wash the topmost dish
                    if (!shop.isDishInSink())
                    {
                        shop.washDish();
                    }
                    else {
                        System.out.println("The dishpit is empty!");
                    }
                ...
                case 6: // Close for the day
                    ...
                    if (shop.isDishInSink() || shop.orderNumber !=0 || shop.transactionNumber != 0)
                    {
                        System.out.println("You cannot close! There is still work to be done!");
                    }
                    else {
                        option = -1;
                    }
    ...
    public static void printMenu(BurritoShop shop) {
        ...
        System.out.println("Orders waiting: " + shop.ordercounter());
        System.out.println("Transactions waiting: " + shop.transactioncounter() + "\n");
